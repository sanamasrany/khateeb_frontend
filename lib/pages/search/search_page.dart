...
import '../portfolio/usersportfolio_page.dart';
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              _buildFab(icon: Icons.person, onPressed: () {
                onClickprofile();
              }, label: "Profile", background: thirdBackColor),
              _buildFab(icon: Icons.home, onPressed: () {
                onClickhome();
              }, label: "Home", background: thirdBackColor),
              _buildFab(icon: Icons.work_history_outlined, onPressed: () {
                Get.toNamed('/jobrequest');
              }, label: "job request", background: thirdBackColor),
              _buildFab(icon: Icons.search,
                  onPressed: () {},
                  label: "Search",
                  background: fifthBackColor),
              _buildFab(icon: Icons.text_snippet, onPressed: () {
                onClicktext();
              }, label: "Add Text", background: thirdBackColor),
            ],
          ),
        ),
      ),
                        ...
                        child: ListTile(
                          leading: CircleAvatar(
                            ...
                            backgroundImage: photo != null && photo.isNotEmpty
                                ? NetworkImage(photo)
                                : const AssetImage("assets/images/kateeb.jpg")
                            as ImageProvider,
                          ),
                          title: Text(
